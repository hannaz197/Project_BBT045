...
Haven gotten and saved all the significant genes, these were further analysed after sorting them according to the code seen below. 
```{r}
...
write.table(significant_genes_0h_30min, file ="significant_genes_30min", sep = "\t" )
write.table(significant_genes_0h_6h, file ="significant_genes_6h", sep = "\t" )
write.table(significant_genes_0h_24h, file ="significnt_genes_24h", sep = "\t" )
...
write.table(common_BaseMeanA_significant_genes_0h_30min, file ="common_BaseMeanA_significant_genes_30min", sep = "\t" )
write.table(common_BaseMeanA_significant_genes_0h_6h, file ="common_BaseMeanAsignificant_genes_6h", sep = "\t" )
write.table(common_BaseMeanA_significant_genes_0h_24h, file ="common_BaseMeanAsignificnt_genes_24h", sep = "\t" )
...
venn.diagram(
        ...
        category.names = c("30 min" , "6h " , "24h"),
        filename = 'VennDiagram_common.png',
        output=TRUE,
