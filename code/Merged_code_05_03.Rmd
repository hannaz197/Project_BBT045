...
#TODO: the names here 
#write.table(common_BaseMeanA_significant_genes_0h_6h, file ="~/Johannas_Rcode/results/differential_expression_results/common_BaseMeanA_significant_genes_6h", sep = "\t" )
#write.table(common_BaseMeanA_significant_genes_0h_24h, file ="~/Johannas_Rcode/results/differential_expression_results/common_BaseMeanA_significant_genes_24h", sep = "\t" )
```
